...
def do_lessons_overlap(lesson1, lesson2):
    ...
    if lesson1.day == lesson2.day:
        # Lessons overlap if one starts before the other finishes (but not at the exact same time)
        # This allows consecutive lessons like 08:30-10:30 and 10:30-12:20
